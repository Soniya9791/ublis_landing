...
const [modeofcontact, setModeofContact] =
  (useState < ModeOfContact) | (undefined > undefined);
  ...
  Axios.post(
...

    {
      personalData: {
        ...
        refWeddingDate: inputs.anniversarydate ? inputs.anniversarydate : null,
      },
    },
    {
      headers: {
